...
EOS_CASES = (
    pytest.param(CarnahanStarling, "satpoints_CS.txt", 1.0, 4.0, {}, 0.0, id="carnahan-starling"),
    pytest.param(PengRobinson, "satpoints_PR.txt", 2.0 / 49.0, 2.0 / 21.0, {"pr_omega": 0.344}, 6e-5, id="peng-robinson"),
    pytest.param(RedlichKwong, "satpoints_RK.txt", 2.0 / 49.0, 2.0 / 21.0, {}, 0.0, id="redlich-kwong"),
    pytest.param(RedlichKwongSoave, "satpoints_SRK.txt", 2.0 / 49.0, 2.0 / 21.0, {"RKS_omega": [0.344]}, 1.5e-3, id="redlich-kwong-soave"),
