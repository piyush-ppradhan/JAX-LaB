...
from jax_lab.core.boundary_conditions import BounceBack, BounceBackMoving, ExtrapolationOutflow, Regularized
...
class Cylinder(KBCSim):
    ...
    def set_boundary_conditions(self):
        ...
        def update_function(ttime: int):
            ...
            velocity = jnp.array([0.0, jnp.cos(ttime / scale) * A / scale], dtype=self.precision_policy.compute_dtype)
